...
import re
from .semantic_analysis import SemanticAnalyzer, SemanticEntity, EntityType
...
class NLPQueryBuilder:
    ...
    def _extract_query_type(self, sparql: str) -> str:
        ...
        if 'SELECT' in sparql_upper:
            return 'SELECT'
        elif 'CONSTRUCT' in sparql_upper:
            return 'CONSTRUCT'
        elif 'ASK' in sparql_upper:
            return 'ASK'
        elif 'DESCRIBE' in sparql_upper:
            return 'DESCRIBE'
        else:
            return 'UNKNOWN'
