...
class ConflictReportGenerator(ProjectionGenerator):
    ...
    def __init__(self, graph: Graph, lookahead_days: int = 7) -> None:
        ...
        self.start_date = datetime.now(tz=UTC).replace(hour=0, minute=0, second=0, microsecond=0)
    ...
    def gather_data(self) -> dict[str, Any]:
        ...
        return {
            "date_range": {"start": self.start_date, "end": self.start_date + timedelta(days=self.lookahead_days)},
