...
"""
            ...
            result = bridge.invoke(
                module_path=str(sig_file), signature_name="ReceiptTestSig", inputs={"input_text": "test"}
            )
...
"""
            ...
            result = bridge.invoke(module_path=str(sig_file), signature_name="MultiOutputSig", inputs={"input": "test"})
