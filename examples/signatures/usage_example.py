...
def example_context_classifier():
    ...
    for activity in activities:
        ...
        print(f"App: {activity.app_name.split('.')[-1]:15} -> Context: {output.context_label:15} (confidence: {output.confidence}%)")
...
def example_complete_workflow():
    ...
    activities = [
        ContextClassifierInput(app_name="com.microsoft.VSCode", domain_names=[], calendar_event="", time_of_day=9, window_title="coding"),
        ContextClassifierInput(app_name="us.zoom.xos", domain_names=[], calendar_event="Standup", time_of_day=10, window_title="meeting"),
        ContextClassifierInput(app_name="com.apple.Safari", domain_names=["github.com"], calendar_event="", time_of_day=11, window_title="research"),
    ]
    ...
    brief_input = DailyBriefInput(
        time_in_app=7.0, domain_visits=25, calendar_busy_hours=3.0,
        context_switches=12, focus_time=2.5, screen_time=8.0,
        meeting_count=4, break_intervals=4
    )
    ...
    wellbeing_input = WellbeingInput(
        screen_time=8.0, focus_time=2.5, meeting_time=3.0,
        break_intervals=4, context_switches=12, work_hours=8.5,
    ...
    feature_input = FeatureAnalyzerInput(
        feature_name="daily_focus",
        feature_values=[2.5, 2.8, 2.3, 2.7, 2.6],
        window="daily"
    )
