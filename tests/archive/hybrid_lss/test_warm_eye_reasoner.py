...
pytestmark = pytest.mark.skipif(not pytest.importorskip("shutil").which("eye"), reason="EYE reasoner not installed")
...
class TestWarmReasoningResult:
    ...
    def test_result_creation(self) -> None:
        ...
        result = WarmReasoningResult(
            success=True, output="@prefix : <#> . :a :b :c .", duration_ms=12.5, queue_wait_ms=0.3, was_warm=True
        )
    ...
    def test_failed_result(self) -> None:
        ...
        result = WarmReasoningResult(success=False, output="", error="Timeout", was_warm=False)
...
class TestPerformance:
    ...
    NOTE: These tests use external EYE subprocesses with process pools.
    Under parallel xdist execution, they may fail due to resource contention.
    Marked with @pytest.mark.eye to allow selective skipping.
    """
