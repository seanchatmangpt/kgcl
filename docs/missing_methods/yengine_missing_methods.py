...
Copy these methods to src/kgcl/yawl/engine/y_engine.py
...
class YEngineStubs:
    """Generated stubs for missing YEngine methods."""
    ...
    def completeWorkItemLogging(
        self, workItem: YWorkItem, logPredicate: str, completionType: WorkItemCompletion, doc: Document
    ) -> None:
    ...
    def getDataDocForWorkItemCompletion(
        self, workItem: YWorkItem, data: str, completionType: WorkItemCompletion
    ) -> Document:
    ...
    def initialise(
        self, pmgr: YPersistenceManager, persisting: bool, gatherHbnStats: bool, redundantMode: bool
    ) -> None:
    ...
    def launchCase(
        ...
        caseParams: str,
        completionObserver: URI,
        caseID: str,
        logData: YLogDataItemList,
        serviceHandle: str,
        delayed: bool,
    ) -> str:
    ...
    def launchCase(
        self, specID: YSpecificationID, caseParams: str, completionObserver: URI, logData: YLogDataItemList
    ) -> str:
        """TODO: Implement launchCase.
    ...
    def logCaseStarted(
        self, spec: YSpecification, runner: YNetRunner, caseParams: str, logData: YLogDataItemList
    ) -> None:
