...
class CasesSubView:
    ...
    async def __aenter__(self) -> CasesSubView:
    ...
    async def delayed_case_launched(self) -> None:
        """
    ...
    async def cancel_case(self) -> None:
        """
    ...
    async def is_running_worklet(self) -> bool:
        """
    ...
    async def reject_worklet(self) -> None:
        """
    ...
    async def reject_worklet(self) -> bool:
        """
