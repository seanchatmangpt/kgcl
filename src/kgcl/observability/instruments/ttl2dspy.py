            ...
            with tracer.start_as_current_span(
                ...
                try:
                    ...
                    if len(args) > 0 and hasattr(args[0], "metrics"):
                        args[0].metrics.record_parse_operation(parser_name, duration_ms, success=True)
                    ...
                    if len(args) > 0 and hasattr(args[0], "metrics"):
                        args[0].metrics.record_parse_operation(parser_name, duration_ms, success=False)
    ...
    def decorator(func: Any) -> Any:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            with tracer.start_as_current_span(
                ...
                attributes={"subsystem": "ttl2dspy", "generator": generator_name, "operation": "generate"},
            ) as span:
                start_time = time.perf_counter()
                ...
                try:
                    ...
                    if len(args) > 0 and hasattr(args[0], "metrics"):
                        ...
                        args[0].metrics.feature_generation_duration.record(duration_ms, {"generator": generator_name})
    ...
    def decorator(func: Any) -> Any:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            with tracer.start_as_current_span(
                ...
                attributes={"subsystem": "ttl2dspy", "cache_name": cache_name, "operation": operation},
            ) as span:
                try:
                    result = func(*args, **kwargs)
