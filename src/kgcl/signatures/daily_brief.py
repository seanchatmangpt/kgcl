...
if DSPY_AVAILABLE:
    class DailyBriefSignature(dspy.Signature):
        ...
        summary: str = dspy.OutputField(
            desc="Concise 1-2 sentence overview of the day's activities"
        )
        highlights: str = dspy.OutputField(
            desc="Key achievements and notable activities (bullet points)"
        )
        patterns: str = dspy.OutputField(
            desc="Observed behavioral patterns (e.g., peak focus times, meeting clusters)"
        )
