...
class TestHealingResult:
    ...
    def test_successful_healing(self) -> None:
        ...
        result = HealingResult(fm_id="FM-HOOK-001", success=True, action_taken="timeout", fallback_used=True)
    ...
    def test_failed_healing(self) -> None:
        ...
        result = HealingResult(
            fm_id="FM-HOOK-002", success=False, action_taken="blocked", original_error="Circular chain detected"
        )
