...
class SwarmCoordinator:
    ...
    Example:
        ...
        task = SwarmTask("integration_test")
    ...
    def __init__(self, max_workers: int = 4) -> None:
        ...
        self._task_history: list[tuple[SwarmTask, TaskResult]] = []
    ...
    def execute(self, task: SwarmTask) -> dict[str, TaskResult]:
    ...
    def task_history(self) -> list[tuple[SwarmTask, TaskResult]]:
